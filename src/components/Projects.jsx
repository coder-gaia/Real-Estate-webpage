...
const Projects = () => {
  ...
  const nextProject = () => {
    setCurrentImg((prevImg) => (prevImg + 1) % projectsData.length);
  };

  const previousProject = () => {
    setCurrentImg((prevImg) =>
      prevImg === 0 ? projectsData.length - 1 : prevImg - 1
    );
  };
    ...
    >
      ...
      <div className="flex justify-end items-center mb-8">
        ...
        <button onClick={nextProject} className="p-3 bg-gray-200 rounded mr-2">
          <img aria-label="Next Projects" src={assets.right_arrow} alt="Next" />
        </button>
      </div>
      ...
      <div className="overflow-hidden">
        <div
          ...
          style={{
            transform: `translateX(-${(currentImg * 100) / cardsToShow}%)`,
          }}
        >
